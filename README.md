...
**কোন লেখা কতবার পড়া হয়েছে** সেটা থিমই গোনে, আলাদা প্লাগইন লাগে না। Posts তালিকায় "পড়া হয়েছে" কলামে দেখা যায় (শিরোনামে ক্লিক করলে সাজানো যায়), আর লেখার এডিটরে Publish বাক্সেও থাকে। গণনাটা হয় ব্রাউজার থেকে (`POST /wp-json/rs/v1/view/<id>`), কারণ পেজ ক্যাশ থাকলে সার্ভারের কোড চলেই না। প্রতিবার খোলাই গোনা হয় — একই পাঠক ফিরে এলেও। একমাত্র ব্যতিক্রম যিনি লেখা সম্পাদনা করতে পারেন; সেটা সার্ভারে `wp_validate_auth_cookie()` দিয়ে যাচাই হয়, ব্রাউজারে নয়, কারণ ক্যাশ করা পেজে ব্রাউজারের কাছে ওই তথ্যটা থাকে না।
