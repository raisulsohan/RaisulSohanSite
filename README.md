...
| শেয়ার করার ছবি | যেসব লেখার নিজের ছবি নেই, শেয়ার করলে সেগুলোর কার্ডে যেটা বসবে। বর্গাকার, ৬০০×৬০০ বা বড়। লেখার ভেতরের ছবি থাকলে সেটাই আগে বসে |
...
| কলাম | কী গোনে |
|---|---|
| পাঠক | যতগুলো ব্রাউজার লেখাটা **প্রথমবার** খুলেছে |
| মোট পড়া | **প্রতিবার** খোলা, একই পাঠক ফিরে এলেও |

যে গল্পে মানুষ বারবার ফিরে আসে, তার দুটো সংখ্যার ফারাক বড় হবে। Posts তালিকায় দুটো কলামেই দেখা যায় (শিরোনামে ক্লিক করলে সাজানো যায়), আর এডিটরের Publish বাক্সেও থাকে।

গণনাটা হয় ব্রাউজার থেকে (`POST /wp-json/rs/v1/view/<id>`), কারণ পেজ ক্যাশ থাকলে সার্ভারের কোড চলেই না। "প্রথমবার কিনা" ব্রাউজারই জানায়, কারণ সেটা কেবল সে-ই জানে — অর্থাৎ "পাঠক" আসলে ব্রাউজার গোনে, মানুষ নয়: একই লোক ফোনে আর ল্যাপটপে পড়লে দুই। যিনি লেখা সম্পাদনা করতে পারেন তিনি কোনোটাতেই গোনা হন না; সেটা যাচাই হয় সার্ভারে `wp_validate_auth_cookie()` দিয়ে, ব্রাউজারে নয়, কারণ ক্যাশ করা পেজে ব্রাউজারের কাছে ওই তথ্যটা থাকে না।
...
- **শেয়ার-ছবি** তিন জায়গায় খোঁজা হয়: ফিচার্ড ইমেজ → লেখার ভেতরের প্রথম ছবি → কাস্টমাইজারের ডিফল্ট। থিম ফিচার্ড ইমেজ কোথাও দেখায় না, তাই শুধু শেয়ারের জন্য আলাদা করে সেট করার দরকার নেই — লেখায় ছবি দিলেই সেটা কার্ডে চলে আসবে
